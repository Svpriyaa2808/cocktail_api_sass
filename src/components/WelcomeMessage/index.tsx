        ...
        <div className="intro">
            <div className="intro__content">
                ...
                <p className="intro__content--para">Cocktails are a delightful fusion of flavors, aromas, and creativity. From timeless classics
                    like the Mojito and Margarita to modern mixes with exotic twists, there's a cocktail for every taste and occasion.Whether you're a mixology enthusiast or just looking for a fun new drink, we've got you covered.</p>
                <p> Click the button to get a random cocktail recipe!</p>
            </div>
